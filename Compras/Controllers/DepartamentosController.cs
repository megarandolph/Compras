...
namespace Compras.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartamentoId,Nombre,Estado")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartamentoId,Nombre,Estado")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
